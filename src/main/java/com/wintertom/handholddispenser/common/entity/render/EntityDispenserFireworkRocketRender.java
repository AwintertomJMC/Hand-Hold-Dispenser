package com.wintertom.handholddispenser.common.entity.render;
...
public class EntityDispenserFireworkRocketRender extends Render<EntityDispenserFireworkRocket>
{

    public static final ResourceLocation RESOURCE_LOCATION = new ResourceLocation(
            HandHoldDispenser.modId,"textures/entity/fireworks.png");

    public EntityDispenserFireworkRocketRender(RenderManager renderManager) {
        super(renderManager);
    }

    @Override
    public void doRender(EntityDispenserFireworkRocket entity, double x, double y, double z, float entityYaw, float partialTicks) {
    ...
    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityDispenserFireworkRocket entity) {
